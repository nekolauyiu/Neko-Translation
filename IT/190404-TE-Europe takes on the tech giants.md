...
Neko的翻译：
欧洲的方法提供了一个新的视角，那就是让消费者们掌握他们的隐私以及如何将他们的数据货币化。他们对这些数据的转换力创造了竞争，而这些竞争应该会促进消费者有更多的选择以及提升竞争的标准。这自然会令科技巨头感到不愉快。他们也许不得不提供一些利润（去年最大五家巨头创造1500亿美元的盈收）给他们的用户，要么加大投资，要么推动市场份额。
...
Neko的翻译：
欧洲的解决方案也有风险。然而在公司之间实现互用性可能比较难实现。迄今为止，通用数据保护条例（GDPR）已经证明了难以实现。开放的数据流和对隐私忧虑不应该互相对立。而欧洲的官僚们则不得不依赖这些企业家——其中许多是美国人——来找到答案。另一个大风险就是欧洲的解决方法不适用于其它地方，这片大陆变成了科技加拉帕戈斯群岛，与主流世界隔绝。但是大公司不愿意将他们的公司分成两个大陆孤岛。有迹象表明，美国正把欧洲变为更科技化：加州正通过法例，与通用数据保护条例靠拢。欧洲正以一种增强消费者的选择权，而不是以国家或秘密垄断力量的方式，慢慢朝着破解大技术迷团的方向前进。假如找到了答案，美国应该毫不犹豫地模仿它们——即使意味着他们将寻找祖先留下的土地。
